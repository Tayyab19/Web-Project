...
function App() {
  const [questions, setQuestions] = useState([
    ...
    },
    {
      ...
      body: "How can I rename a local branch which hasn't been pushed to a remote repository? In case you need to rename a remote branch as well: How do I rename both a Git local and remote branch name?",
